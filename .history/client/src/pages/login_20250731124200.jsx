      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg top-5 w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <form>
          {state === 'Sign Up' && (
            ...
            <input onChange={(e) => setName(e.target.value)} value={} type="text" placeholder='Full Name' className='bg-transparent outline-none' required/>
          </div>
          )}
          <div className=' mb-4 flex items-center gap-4 w-full px-5 py-2.5 bg-[#333A5C] rounded-full shadow-md'>
            <img src={assets.mail_icon} alt="" />
            <input onChange={(e) => setEmail(e.target.value)} type="email" placeholder='Email Id' className='bg-transparent outline-none' required/>
          </div>
          <div className=' mb-4 flex items-center gap-4 w-full px-5 py-2.5 bg-[#333A5C] rounded-full shadow-md'>
            <img src={assets.lock_icon} alt="" />
            <input onChange={(e) => setPassword(e.target.value)} type="email" placeholder='Password' className='bg-transparent outline-none' required/>
          </div>
