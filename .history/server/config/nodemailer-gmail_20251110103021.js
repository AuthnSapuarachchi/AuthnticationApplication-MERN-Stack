...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    user:
      process.env.SMTP_USER || process.env.EMAIL_USER || process.env.EMAIL || process.env.SMTP_EMAIL,
    pass:
      process.env.SMTP_PASSWORD || process.env.EMAIL_PASS || process.env.EMAIL_PASSWORD || process.env.SMTP_PASSWORD,
  },
  tls: {
