...
import { login, logout, register, verifyEmail, sendVerifyOtp, testEmail, testAuth, isAuthenticated, sendResetOtp } from '../controllers/authController.js';
...
authRoutes.post('/send-reset-otp', userAuth, sendResetOtp);
authRoutes.post('/reset-password', userAuth, sendResetOtp);
