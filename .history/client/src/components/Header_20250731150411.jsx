...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      font-medium mb-2'>Hey {userData ? userData.name : Developer} Developer<img className='w-8 aspect-square' 
        src={assets.hand_wave} /></h1>
        <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Welcome to AuthCodeLab</h2>
        <p className='mb-8 max-w-md'>Let's start witha quick product tour and we will have you up and running in no time</p>
